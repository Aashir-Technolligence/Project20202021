...
public class HomeTeaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_home_tea, container, false);
        teclistView = (RecyclerView) view.findViewById(R.id.tecRecycler);
        teacherAttrs = new ArrayList<>();//constructor
        teclistView.setLayoutManager(new LinearLayoutManager(getContext()));
                    ...
                    if (dataSnapshot.exists()) {
                        try{
                            ...
                            for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                TeacherAttr tp = dataSnapshot1.getValue(TeacherAttr.class);
                                teacherAttrs.add(tp);
                            }
//                            Collections.reverse(studentAttrs);
                            teclistView.setAdapter(new TeacherListAdapter(teacherAttrs,getContext()));
                        }
                        catch (Exception e){}
                    } else {
