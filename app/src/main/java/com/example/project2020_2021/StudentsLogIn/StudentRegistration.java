...
import com.example.project2020_2021.StudentsSignUp.StudentSignUp;
...
public class StudentRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lregisstu = (TextView) findViewById(R.id.sturegister);
        ...
        lregisstu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pairs[0] = new Pair<View,String>(findViewById(R.id.sturegister),"tsturegister");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(StudentRegistration.this,pairs);
        ...
        crossopt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StudentRegistration.this, AccountActivity.class);
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StudentRegistration.this, StuForgotPass.class);
